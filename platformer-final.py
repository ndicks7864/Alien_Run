...
hurt_snd = load_sound('assets/sounds/hurt.ogg')
soda_snd = load_sound('assets/sounds/soda_can.ogg')

# Images
idle = load_image('assets/images/characters/alien_front.png')
walk = [load_image('assets/images/characters/alien_walk1.png'),
        load_image('assets/images/characters/alien_walk2.png')]
jump = load_image('assets/images/characters/alien_jump.png')
hurt = load_image('assets/images/characters/alien_hurt.png')
happy = load_image('assets/images/characters/happy.png')

enemy = [load_image('assets/images/characters/slimeWalk1.png'),
         load_image('assets/images/characters/slimeWalk2.png')]

enemy_hurt = load_image('assets/images/characters/slimeDead1.png')

platform_enemy = [load_image('assets/images/characters/slimeWalk3.png'),
                  load_image('assets/images/characters/slimeWalk3.png')]

platform_enemy_hurt = load_image('assets/images/characters/slimeDead2.png')
...
tile_images = { "PurplePlatform": load_image('assets/images/tiles/stone.png'),
                "PurpleRightEdge": load_image('assets/images/tiles/stoneCliffRight.png'),
                "PurpleMiddle": load_image('assets/images/tiles/stoneMid.png'),
                "PurpleLeftEdge": load_image('assets/images/tiles/stoneCliffLeft.png'),
                "BluePlatform": load_image('assets/images/tiles/stone_2.png'),
                "BlueRightEdge": load_image('assets/images/tiles/stoneCliffRight_2.png'),
                "BlueMiddle": load_image('assets/images/tiles/stoneMid_2.png'),
                "BlueLeftEdge": load_image('assets/images/tiles/stoneCliffLeft_2.png'),
                "RedPlatform": load_image('assets/images/tiles/stone_3.png'),
                "RedRightEdge": load_image('assets/images/tiles/stoneCliffRight_3.png'),
                "RedMiddle": load_image('assets/images/tiles/stoneMid_3.png'),
                "RedLeftEdge": load_image('assets/images/tiles/stoneCliffLeft_3.png'),
                "BlackPlatform": load_image('assets/images/tiles/stone_4.png'),
                "BlackRightEdge": load_image('assets/images/tiles/stoneCliffRight_4.png'),
                "BlackMiddle": load_image('assets/images/tiles/stoneMid_4.png'),
                "BlackLeftEdge": load_image('assets/images/tiles/stoneCliffLeft_4.png'),
                "Plant": load_image('assets/images/tiles/plantPurple.png'),
                "BluePlant": load_image('assets/images/tiles/plantBlue.png'),
                "RedPlant": load_image('assets/images/tiles/plantRed.png'),
                "BlackPlant": load_image('assets/images/tiles/plantBlack.png'),
                "FlagTop": load_image('assets/images/tiles/medievalTile_166.png'),
                "FlagPole": load_image('assets/images/tiles/medievalTile_190.png'),
                "SpaceShip": load_image('assets/images/tiles/platformPack_tile048.png')}
        
basic_enemy_images = { "walk_lt": enemy,
                       "walk_rt": [flip_image(img) for img in enemy],
                       "dead": enemy_hurt }

platform_enemy_images = { "walk_lt": platform_enemy,
                          "walk_rt": [flip_image(img) for img in platform_enemy],
                          "dead": platform_enemy_hurt }

item_images = { "Gem": load_image('assets/images/items/platformPack_item008.png'),
                "Star": load_image('assets/images/items/star.png'),
                "Soda": load_image('assets/images/items/soda.png')}
...
class Soda(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        super().__init__()
...
class Level():
    ...
    def load_items(self):
        ...
        for element in self.map_data['items']:
            ...
            if kind == "Gem" or "Star" or "Soda":
                g = Gem(x, y, item_images[kind])
                s = Star(x, y, item_images[kind])
                a = Soda(x, y, item_images[kind])
                
            self.items.add(g,s,a)
...
class Game():
    ...
    def show_pause_screen(self):
        screen.fill(WHITE)
        text = font_lg.render("Pause", 1, BLACK)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = SCREEN_HEIGHT // 2
        screen.blit(text, rect)
    ...
    def show_stats(self):
        ...
        full_heart = load_image('assets/images/items/full_heart.png')
        half_heart = load_image('assets/images/items/half_heart.png')
        empty_heart = load_image('assets/images/items/empty_heart.png')
        if self.hero.hearts == 6:
            '''heart 1'''
            rect = full_heart.get_rect()
            rect.left = 85
            rect.top = 5
            '''heart 2'''
            screen.blit(full_heart, rect)
            rect.left = 45
            rect.top = 5
            '''heart 3'''
            screen.blit(full_heart, rect)
            ...
            '''heart 1'''
            rect = half_heart.get_rect()
            rect.left = 85
            rect.top = 5
            screen.blit(half_heart, rect)
            '''heart 1'''
            rect = full_heart.get_rect()
            rect.left = 45
            rect.top = 5
        ...
        if self.hero.hearts == 4:
            '''heart 1'''
            rect = empty_heart.get_rect()
            rect.left = 85
            rect.top = 5
            screen.blit(empty_heart, rect)
            '''heart 1'''
            rect = full_heart.get_rect()
            rect.left = 45
            rect.top = 5
